...
SRCS=main.c collision.c gameplay.c pause.c ssmtf_logo.c state.c title_screen.c util.c connecting.c lobby.c net/disasteroids_net.c assets/alien.c assets/assets.c assets/audio.c assets/disasteroid.c assets/font.c assets/ship.c assets/star.c objects/alien.c objects/disasteroid.c objects/explosion.c objects/objects.c objects/projectile.c objects/ship.c objects/star.c
